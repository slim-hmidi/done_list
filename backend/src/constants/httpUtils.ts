...
const successMessages = {
  ...
  tagFetchSuccess: 'Tag(s) fetched successfully',
...
const errorMessages = {
  ...
  minLengthRequired: (arg: string) => `${arg} Should contain at least 2 characters`,
  ...
  invalidTaskId: 'No task(s) found for the given id',
...
export { httpStatuscodes, errorMessages, successMessages };
